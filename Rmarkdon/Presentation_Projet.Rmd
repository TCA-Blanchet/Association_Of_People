...
# Jeudi 12 février
Kevine et Tibault ont travaillé sur l'UI de la page d'accueil et de l'onglet about, nous sommes répartis les onglets, nous avons rajouter des images, revue la couleur de l'interface, ajouter des titres, sous-titres ainsi que des boutons pour faciliter le déplacement dans l'interface. Nous avons rencontrer quelques problèmes comme l'impossibilité de passé un texte en justifier, l'emplacement des boutons et leurs apparences... Cependant en fin de séance nous avions pu régler la majorité de nos problèmes. Seul résider un bouton en transparent que Julian a retravaillé et rendu fonctionnel.
